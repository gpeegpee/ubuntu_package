...
-DBUILD_TIFF=ON -DWITH_TIFF=ON -DWITH_QT=ON -DWITH_VTK=ON -DWITH_TBB=ON -DWITH_EIGEN=ON \
-DWITH_GDAL=OFF -DWITH_OPENCL=ON -DWITH_OPENGL=ON -DWITH_IPP=ON -DWITH_OPENMP=ON -DBUILD_EXAMPLES=ON \
-DWITH_V4L=ON \
